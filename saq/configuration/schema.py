...
class CrashReportingConfig(BaseModel):
    ...
    retention_days: int = Field(default=30, description="number of days crash reports are kept before `ace crash prune` (run hourly from bin/hourly-maintenance.sh) removes the directory and its index row")
