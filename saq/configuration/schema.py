...
class SplunkConfig(BaseModel):
    ...
    max_consecutive_auth_failures: int = Field(default=20, description="how many consecutive 401s to tolerate while polling an already-dispatched search before failing the query (rides out transient search head cluster proxy failures)")
