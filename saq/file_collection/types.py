...
class FileCollectionWorkItem(BaseModel):
    ...
    alert_uuid: str = Field(..., description="UUID of the originating alert.")
    storage_dir: str = Field(..., description="Path to the alert's storage directory for collected files.")
