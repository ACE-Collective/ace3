...
F_EMAIL_DKIM_SIGNING_DOMAIN = 'email_dkim_signing_domain'
F_EMAIL_ENVELOPE_MAIL_FROM = 'email_envelope_mail_from'
F_EMAIL_ENVELOPE_RCPT_TO = 'email_envelope_rcpt_to'
F_EMAIL_FIRST_HOP_FROM = 'email_first_hop_from'
F_EMAIL_FIRST_HOP_HELO = 'email_first_hop_helo'
F_EMAIL_FIRST_HOP_IP = 'email_first_hop_ip'
F_EMAIL_FROM = 'email_from'
F_EMAIL_HEADER = 'email_header'
F_EMAIL_REPLY_TO = 'email_reply_to'
F_EMAIL_RETURN_PATH = 'email_return_path'
F_EMAIL_SENDER_TENANT_ID = 'email_sender_tenant_id'
