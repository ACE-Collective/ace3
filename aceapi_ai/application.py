...
alert search (the RAG surface for agentic triage), and health. It runs in its own container with no encryption capability (see
...
from aceapi_ai.search.router import router as search_router
