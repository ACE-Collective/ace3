...
def downgrade() -> None:
    ...
    # ace database, so there is nothing to revert to. Running it would DROP
    ...
    raise RuntimeError(
        "refusing to downgrade the initial ace schema: it would drop the "
        "entire ace database. If you really need to tear it down, do it "
