...
from app.analysis.views.session.filters import _reset_filters, _reset_filters_needs_research, _reset_filters_special, _reset_filters_unreviewed, get_existing_filter, getFilters, reset_checked_alerts, reset_pagination, reset_sort_filter
...
@analysis.route('/reset_filters_unreviewed', methods=['GET'])
@login_required
def reset_filters_unreviewed():
    _reset_filters_unreviewed()
    reset_pagination()
    reset_sort_filter()
    reset_checked_alerts()
